...
describe('streamerService', () => {
  ...
  describe('issueStreamTicket', () => {
    it('should issue ticket when session state is Running', async () => {
      ...
      const streamUrl = 'http://127.0.0.1:8000/#!action=stream&udid=emulator-5554&player=broadway&ws=ws%3A%2F%2F127.0.0.1%3A8000%2F%3Faction%3Dproxy-adb%26remote%3Dtcp%253A8886%26udid%3Demulator-5554';
      const wsUrl = 'ws://127.0.0.1:8000/?action=proxy-adb&remote=tcp%3A8886&udid=emulator-5554';
      const mockTicket = {
